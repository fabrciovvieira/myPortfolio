export const SKILLS = [
    ...
    },
    {
        ...
        icon: "FaTools",
        skills: [
            {skill: "Git e GitHub", percentage: "70%"},
            {skill: "Visual Studio Code", percentage: "75%"},
            {skill: "Design Responsivo", percentage: "60%"},
        ],
    },
    {
        title: "Soft Skills",
        icon: "GiSkills",
        skills: [
            { skill: "Solução de problemas", percentage: "85%" },
            { skill: "Colaboração", percentage: "85%" },
...
export const PROJECTS = [
    ...
    },
    {
        ...
        link_repo: "https://github.com/fabrciovvieira/listaDeTarefas",
        link_acao: "https://fabrciovvieira.github.io/listaDeTarefas/",
    ...
    },
    {
        ...
        link_repo: "https://github.com/fabrciovvieira/countdown_with_React",
        description: "Um simples e elegante contador regressivo em React que permite aos usuários configurarem uma data, imagem, título, estilo e descrição para criar seu próprio contador personalizado. Este projeto foi desenvolvido para fornecer uma maneira intuitiva e visualmente atraente de mostrar quantos dias faltam até um evento especial, como feriados, aniversários, lançamentos de produtos, entre outros."
    },
    {
        title: "Projeto TMDB api em React",
        technologies: [
            "HTML5 - 2.9%",
            "CSS3 - 32.4%",
            "JavaScript - 64.7%"
